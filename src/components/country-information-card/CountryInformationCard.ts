        ...
        <div class="cases">
            ...
            <div class="progress-bar-light-grey">
                <div
                    ...
                    style=${`width: ${(100 * this.statistic.cases.total) / this.statistic.population}%`}>
                </div>
            </div>
        ...
        <div class="recovered">
            ...
            <div class="progress-bar-light-grey">
                <div
                    ...
                    style=${`width: ${(100 * this.statistic.cases.recovered) / this.statistic.population}%`}>
                </div>
            </div>
        </div>
        <div class="deaths">
            ...
            <div class="progress-bar-light-grey">
                <div
                    ...
                    style=${`width: ${(100 * this.statistic.deaths.total) / this.statistic.population}%`}>
                </div>
            </div>
